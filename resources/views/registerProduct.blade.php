    ...
    <div class="navbar-fixed">
        <nav>
            <div class="nav-wrapper green accent-3">
                <a id="logo-in-generateCoupon" class="brand-logo white-text center font-texts">Cadastrar Produto</a>
                ...
                <form action="{{ route('product-save')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="input-field col s9 offset-s2 ">
                            ...
                            <input id="name-product" name="name-product" type="text" class="validate" required>
                    ...
                    <div class="row">
                        <div class="input-field col s9 offset-s2 ">
                            ...
                            <input type="text" required maxlength="8" id="price" name="price" onkeyup="formatarMoeda()">
